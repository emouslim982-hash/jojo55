...
let score = 0;
const WIN_SCORE = 6; // Hearts needed to fill the meter
let player;
let hearts = [];
...
class Player {
    constructor() {
        ...
        this.speed = Math.min(canvas.width / 40, 12);
        this.dx = 0;
    }
...
yesBtn.addEventListener("click", () => {
    ...
    // الانتقال للموقع الثاني
    setTimeout(() => {
        window.location.href = "../surprise/index4.html";
    }, 500);
